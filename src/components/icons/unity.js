...
const UnityLogo = ({classProp, width, height}) => (
    <svg version="1.1" height="inherit" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className={classProp}>
    <title>Unity</title>
