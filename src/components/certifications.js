    ...
    <div className="sectionBackground" id="certifications">
      ...
      <div className="noMarkers " style={gridStyles}>
        <a
          ...
          href="https://www.freecodecamp.org/certification/Mackenzie-May/responsive-web-design">
          <p className="certificateHeader">Responsive Web Design</p>
          <img
            src={responsiveWebDesignCertificate}
            alt="responsiveCert"
            width="100%"
            display="block"
          />
        ...
        <a
          className="certificate"
          href="https://www.freecodecamp.org/certification/Mackenzie-May/javascript-algorithms-and-data-structures">
        ...
        <a
          className="certificate"
          href="https://www.freecodecamp.org/certification/Mackenzie-May/front-end-development-libraries">
